...
var subdivbox2 = document.getElementById('subdivbox2');
var i = 0
var j = 0
var k = 0
var l = 0
...
function fdiv1(){
  if(n == 0) {
    ...
    subdiv1.style.opacity = "1"
    subdiv1.style.transformOrigin = "none"
    subdiv1.style.transform = "none"
    n = 1
  } else {
    subcapek.style.gridTemplateRows = "20px 60px 10px 60px 10px 60px 10px 60px"
    subdiv1.style.opacity = "0"
    subdiv1.style.transformOrigin = "top left"
    subdiv1.style.transform = "rotate(45deg)"
    n = 0
  }
}
function fdivbox2(){
  if(o == 0) {
    subdivbox2.style.opacity = "1"
    o = 1
  } else {
    subdivbox2.style.opacity = "0"
    o = 0
  }
}